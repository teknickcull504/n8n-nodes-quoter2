...
exports.manufacturerFields = exports.manufacturerOperations = void 0;
exports.manufacturerOperations = [
    {
...
exports.manufacturerFields = [
    ...
    },
    {
        ...
        displayOptions: { show: { resource: ['manufacturer'], operation: ['create'] } },
        options: [
            { displayName: 'Website', name: 'website', type: 'string', default: '', description: 'Manufacturer website URL' },
        ],
    },
    // delete
    {
...
//# sourceMappingURL=ManufacturerDescription.js.map