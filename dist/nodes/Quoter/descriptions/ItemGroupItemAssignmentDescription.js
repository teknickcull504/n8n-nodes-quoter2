...
exports.itemGroupItemAssignmentFields = exports.itemGroupItemAssignmentOperations = void 0;
exports.itemGroupItemAssignmentOperations = [
    {
...
exports.itemGroupItemAssignmentFields = [
    // create
    {
    ...
    },
    {
        ...
        displayOptions: { show: { resource: ['itemGroupItemAssignment'], operation: ['getAll'] } },
        options: [
            { displayName: 'Item Group ID', name: 'item_group_id', type: 'string', default: '' },
            { displayName: 'Item ID', name: 'item_id', type: 'string', default: '' },
            { displayName: 'Sort By', name: 'sort_by', type: 'string', default: '' },
        ],
    },
];
//# sourceMappingURL=ItemGroupItemAssignmentDescription.js.map